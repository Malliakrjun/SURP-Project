...
urlpatterns=[
    url(r'^$',views.home),
    url(r'^login/$',views.myuser_login,{'template_name':'accounts/login.html','authentication_form':LoginForm},name='login'),
    ...
    url(r'^reset-password/confirm/(?P<token>.+)-(?P<uidb64>[0-9A-Za-z]+)/$',password_reset_confirm,{'template_name':
